...
alert("hello");
let textlabelElement = document.getElementById("textInputLabel");
...
// Students work in a small classroom setting and use real-word technologies to learn the
// fundamentals of coding, app development, the leadership,
// and the life skills needed for a successful career and job market competitiveness.



// Exercise 3:
// Using the exercise above, create a reset button that will erase everthing from the label so
